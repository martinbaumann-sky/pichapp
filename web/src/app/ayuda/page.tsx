    ...
    <main className="max-w-3xl mx-auto px-6 py-12">
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-800">
          <li>Crea tu cuenta con tu nombre, comuna y telefono.</li>
          <li>Explora partidos por comuna, fecha y nivel.</li>
          <li>Unete y toma tu cupo gratis.</li>
        </ul>
      </section>
      ...
      <section className="mb-10">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-gray-800">
          <li>Ve a la seccion Explorar y filtra por lo que te interese.</li>
          <li>Revisa los detalles del partido y la reputacion del organizador.</li>
          <li>Presiona "Unirme" y confirma tu cupo gratis.</li>
        </ol>
        <p className="text-gray-600 mt-3 text-sm">Tu cupo queda confirmado al instante y el organizador puede comunicarse contigo si es necesario.</p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-800">
          ...
          <li>Administra asistentes, reglas y comunicacion (por ejemplo, no-show).</li>
        </ul>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-800">
          ...
          <li>Si necesitas cancelar, avisa a los jugadores con anticipacion.</li>
          <li>Define reglas claras para no-show y compartelas en la descripcion.</li>
        </ul>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-800">
          ...
          <li>Revisa la calificacion del organizador antes de unirte.</li>
        </ul>
      </section>

      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-3">Mas informacion</h2>
        <ul className="list-disc pl-5 space-y-2 text-gray-800">
          <li>
            Terminos y Condiciones: <a href="/terminos" className="underline">/terminos</a>
          </li>
          <li>
            Politica de Privacidad: <a href="/privacidad" className="underline">/privacidad</a>
          </li>
        </ul>
      </section>
