...
function PagoErrorContent() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6">
      ...
      <p className="text-[color:var(--fg-muted)] mb-6">Puedes reintentar el proceso.</p>
      <Link href={href} className="px-6 py-3 bg-[color:var(--brand-1)] text-white rounded-lg hover:bg-brand-600">Reintentar</Link>
    </div>
  );
}
